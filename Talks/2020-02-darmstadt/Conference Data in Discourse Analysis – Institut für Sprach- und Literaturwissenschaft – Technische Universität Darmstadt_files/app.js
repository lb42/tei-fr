...
$(function(){
var textwidth = $("#institution-name").width();
var framewidth = $("#institution-name-container").width();
if(textwidth > framewidth){
var scalefactor = framewidth/textwidth;
$("#institution-name").css('transform-origin', '0 0').css('transform', 'scaleX('+ scalefactor +')');
...
$(this).replaceWith('<a class="link tel" itemprop="telephone" href="'+protocol+':'+tel+'" title="Anrufen: '+tel+'"><span class="icon far fa-phone-alt"></span>'+$(this).html()+'</a>');
});
...
/*
$('.main-heading > button').click(function(){
var highestMenuPanelHeight = 0;
$('ul.panel-menu').each(function(){
console.log("Aktuelle Höhe: " +$(this).outerHeight());
if($(this).outerHeight() > highestMenuPanelHeight){
highestMenuPanelHeight = $(this).outerHeight();
}
});
console.log("Höchstes Menü: " +highestMenuPanelHeight);
$('.panel-menu').height(highestMenuPanelHeight);
});
$("#phablet-overlay-toggle").click(function(){
$('.main-pusher').each(function(){
$(this).css("height", $(this).children(".level.frame[style!='display: none;']").last().css("height"));
console.log($(this).children(".level.frame[style!='display: none;']").last().css("height"));
});
});
*/
});
...
/* harmony import */ var gsap_TweenLite__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(gsap_TweenLite__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var gsap_TimelineLite__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(gsap_TimelineLite__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var gsap_CSSPlugin__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(gsap_CSSPlugin__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var gsap_EasePack__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(gsap_EasePack__WEBPACK_IMPORTED_MODULE_4__);
// import { TweenLite, TimelineLite, CSSPlugin, ScrollToPlugin } from 'gsap';
// import CSSPlugin, ScrollToPlugin,
// import 'gsap/src/uncompressed/plugins/CSSPlugin';
var Tween = window.TweenMax || window.TweenLite;
var Timeline = window.TimelineMax || window.TimelineLite;
Tween && (Tween.defaultEase = gsap_EasePack__WEBPACK_IMPORTED_MODULE_4__["Power1"].easeInOut);
Timeline && (Timeline.defaultEase = gsap_EasePack__WEBPACK_IMPORTED_MODULE_4__["Power1"].easeInOut);
/***/ }),
/***/ "./_javascripts/abstract/vue.js":
/*!**************************************!*\
!*** ./_javascripts/abstract/vue.js ***!
\**************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
/***/ }),
/***/ "./_javascripts/modules/data.js":
/*!**************************************!*\
!*** ./_javascripts/modules/data.js ***!
\**************************************/
/*! exports provided: fastBlocks, sitemap, menuPath */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fastBlocks", function() { return fastBlocks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sitemap", function() { return sitemap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "menuPath", function() { return menuPath; });
...
/***/ }),
/***/ "./_javascripts/modules/desktop-menu.js":
/*!**********************************************!*\
!*** ./_javascripts/modules/desktop-menu.js ***!
\**********************************************/
/*! exports provided: desktopMenuVM */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "desktopMenuVM", function() { return desktopMenuVM; });
...
/* harmony import */ var _abstract_gsap__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../abstract/gsap */ "./_javascripts/abstract/gsap.js");
/* harmony import */ var _abstract_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../abstract/vue */ "./_javascripts/abstract/vue.js");
/* harmony import */ var _page_header_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./page-header.js */ "./_javascripts/modules/page-header.js");
/* harmony import */ var _data_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./data.js */ "./_javascripts/modules/data.js");
...
if (desktopMenu) {
desktopMenuVM = new _abstract_vue__WEBPACK_IMPORTED_MODULE_9__["default"]({
el: desktopMenu,
name: 'desktop-menu',
data: function data() {
return {
sitemap: _data_js__WEBPACK_IMPORTED_MODULE_11__["sitemap"],
fastBlocks: _data_js__WEBPACK_IMPORTED_MODULE_11__["fastBlocks"],
menuPath: _data_js__WEBPACK_IMPORTED_MODULE_11__["menuPath"],
path: '',
focPath: '',
fastIsOpen: false,
searchIsOpen: false,
...
if($(".main-heading.selected").length){
$(".main-heading.selected").addClass("unselected").removeClass("selected");
}
this.focPath = n.join('-');
},
...
var _this3 = this;
if (this.fastIsOpen) {
_abstract_gsap__WEBPACK_IMPORTED_MODULE_8__["Tween"].to(this.$refs.liner, 0.25, {
y: 0,
...
_abstract_gsap__WEBPACK_IMPORTED_MODULE_8__["Tween"].to(_this3.$refs.liner, 0.25, {
y: shiftHeight
});
...
_abstract_gsap__WEBPACK_IMPORTED_MODULE_8__["Tween"].to(_this4.$refs.liner, 0.25, {
y: shiftHeight
});
...
mounted: function mounted() {
var _this5 = this;
var headroom = new headroom_js__WEBPACK_IMPORTED_MODULE_7___default.a(this.$el, headroomOptions);
headroom.init();
...
var _this6 = this;
if (this.path.length) {
_page_header_js__WEBPACK_IMPORTED_MODULE_10__["pageHeaderVM"].$emit('setOverlay');
...
_page_header_js__WEBPACK_IMPORTED_MODULE_10__["pageHeaderVM"].$emit('removeOverlay');
$(".main-heading.unselected").removeClass("unselected").addClass("selected");
}
}
}
});
...
document.getElementById('desktop-menu').style.paddingRight = "".concat(scrollbarWidth, "px");
});
$(document).on('hidden.bs.modal', function () {
document.getElementById('desktop-menu').style.paddingRight = "";
return desktopMenuVM.$emit('modalClose');
});
/***/ }),
/***/ "./_javascripts/modules/page-header.js":
/*!*********************************************!*\
!*** ./_javascripts/modules/page-header.js ***!
\*********************************************/
/*! exports provided: pageHeaderVM */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pageHeaderVM", function() { return pageHeaderVM; });
/* harmony import */ var _abstract_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../abstract/vue */ "./_javascripts/abstract/vue.js");
/* harmony import */ var _desktop_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./desktop-menu.js */ "./_javascripts/modules/desktop-menu.js");
//
// PAGE HEADER
//
var pageHeaderVM;
...
if (pageHeader) {
pageHeaderVM = new _abstract_vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
el: pageHeader,
data: {
overlay: false
},
...
_desktop_menu_js__WEBPACK_IMPORTED_MODULE_1__["desktopMenuVM"].$emit('esc');
}
},
created: function created() {
var _this = this;
this.$on('setOverlay', function (e) {
return _this.overlay = true;
});
this.$on('removeOverlay', function (e) {
...
/***/ }),
/***/ "./_javascripts/modules/phablet-menu.js":
/*!**********************************************!*\
!*** ./_javascripts/modules/phablet-menu.js ***!
\**********************************************/
/*! exports provided: phabletMenuVM */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "phabletMenuVM", function() { return phabletMenuVM; });
...
/* harmony import */ var _abstract_gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../abstract/gsap */ "./_javascripts/abstract/gsap.js");
/* harmony import */ var _abstract_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../abstract/vue */ "./_javascripts/abstract/vue.js");
function uid() {
...
_abstract_gsap__WEBPACK_IMPORTED_MODULE_3__["Tween"].set(el, {
height: 'auto'
});
_abstract_gsap__WEBPACK_IMPORTED_MODULE_3__["Tween"].from(el, 0.2, {
height: 0,
onComplete: done
});
},
leave: function leave(el, done) {
_abstract_gsap__WEBPACK_IMPORTED_MODULE_3__["Tween"].to(el, 0.2, {
height: 0,
onComplete: done
});
},
afterEnter: function afterEnter(el) {
_abstract_gsap__WEBPACK_IMPORTED_MODULE_3__["Tween"].to(this.$refs.target, 0.2, {
autoAlpha: 1
});
},
...
mounted: function mounted() {
_abstract_gsap__WEBPACK_IMPORTED_MODULE_3__["Tween"].set(this.$refs.target, {
autoAlpha: 0
});
},
watch: {
...
//
var phabletMenuVM;
var phabletMenu = document.getElementById('phablet-menu');
if (phabletMenu) {
phabletMenuVM = new _abstract_vue__WEBPACK_IMPORTED_MODULE_4__["default"]({
el: phabletMenu,
components: {
...
console.log("intPath: " + this.intPath);
if (dir == 'up'){
...
var headroom = new headroom_js__WEBPACK_IMPORTED_MODULE_2___default.a(this.$el, {
offset: 260,
classes: classes
});
headroom.init();
...
$(document).on('hidden.bs.modal', function () {
return phabletMenuVM.$emit('modalClose');
});
/***/ }),
/***/ "./media/resources/scripts/social_media.js":
/*!***********************!*\
!*** ./media/resources/scripts/social_media.js ***!
\***********************/
/*! exports provided: socialMediaVM */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "socialMediaVM", function() { return socialMediaVM; });
/* harmony import */ var _abstract_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../abstract/vue */ "./_javascripts/abstract/vue.js");
var socialMediaVM;
var socialMedia = document.getElementById('socialMedia');
if (socialMedia) {
socialMediaVM = new _abstract_vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
el: '#socialMedia',
data: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _javascripts_modules_page_header_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../_javascripts/modules/page-header.js */ "./_javascripts/modules/page-header.js");
/* harmony import */ var _javascripts_modules_desktop_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_javascripts/modules/desktop-menu.js */ "./_javascripts/modules/desktop-menu.js");
/* harmony import */ var _javascripts_modules_phablet_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_javascripts/modules/phablet-menu.js */ "./_javascripts/modules/phablet-menu.js");
/* harmony import */ var _javascripts_modules_social_media_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../media/resources/scripts/social_media.js */ "./media/resources/scripts/social_media.js");
/***/ })
/******/ });