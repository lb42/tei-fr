...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/">
		...
		<choose>
			<when test="$typeIndex='Codico'">
				<xsl:for-each select="//tei:nym[@type='codico']">
					<xsl:sort select="translate(.,$lower,$upper)" order="ascending" data-type="text" />
					<xsl:apply-templates select="."/>
				</xsl:for-each>
			</when>
			<when test="$typeIndex='Bibliotheconomie_thematique'">
				<xsl:for-each select="//tei:nym[@type='bibliotheconomie_thematique']">
					<xsl:sort select="translate(.,$lower,$upper)" order="ascending" data-type="text" />
					<xsl:apply-templates select="."/>
				</xsl:for-each>
			</when>	
			<when test="$typeIndex='Bibliotheconomie_locatif'">
				<xsl:for-each select="//tei:nym[@type='bibliotheconomie_locatif']">
					<xsl:sort select="translate(.,$lower,$upper)" order="ascending" data-type="text" />
					<xsl:apply-templates select="."/>
				</xsl:for-each>
			</when>
			<when test="$typeIndex='Bibliotheconomie_format'">
				<xsl:for-each select="//tei:nym[@type='bibliotheconomie_format']">
					<xsl:sort select="translate(.,$lower,$upper)" order="ascending" data-type="text" />
					<xsl:apply-templates select="."/>
				</xsl:for-each>
			</when>
...
<xsl:template match="tei:nym[@type='codico']">
<xsl:choose>
...
<xsl:template match="tei:nym[@type='type_oeuvre']">
<xsl:choose>
...
<xsl:template match="tei:nym[@type='type_livre']">
<xsl:choose>
...
<xsl:template match="tei:nym[@type='type_objet']">
<xsl:choose>
...
<xsl:template match="tei:nym[@type='bibliotheconomie_format']">
<xsl:choose>
<xsl:when test="parent::tei:nym!=''">
<xsl:value-of select="../tei:ab"/> • <xsl:value-of select="tei:ab"/> > <xsl:text>
</xsl:text><xsl:value-of select="@xml:id"/><xsl:text>
...
<xsl:template match="tei:nym[@type='bibliotheconomie_thematique']">
<xsl:choose>
...
<xsl:template match="tei:nym[@type='bibliotheconomie_locatif']">
