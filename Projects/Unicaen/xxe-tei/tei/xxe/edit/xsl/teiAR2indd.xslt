...
<xsl:template match="@aid:pstyle">
	<xsl:attribute name="aid:pstyle">
		<xsl:value-of select="concat('trad-',.)"/>
	</xsl:attribute>
</xsl:template>
		...
		<xsl:copy>
			<xsl:choose>
				<xsl:when test="local-name(preceding-sibling::node()[1])='head' and @aid:pstyle='txt_Normal'">
					<xsl:attribute name="aid:pstyle">trad-txt_Normal_sa</xsl:attribute>
				</xsl:when>
				<xsl:when test="local-name(preceding-sibling::node()[1])='head' and @aid:pstyle='Txt_Standard'">
					<xsl:attribute name="aid:pstyle">trad-Txt_Standard_sa</xsl:attribute>
				</xsl:when>
				<xsl:otherwise>
					<xsl:apply-templates select="./@*"/>
				</xsl:otherwise>
		...
		<xsl:element name="head">
			<xsl:choose>
				<xsl:when test="@aid:pstyle='T_1'">
					<xsl:attribute name="aid:pstyle">trad-T_a</xsl:attribute>
				</xsl:when>
				<xsl:when test="@aid:pstyle='T_2'">
					<xsl:attribute name="aid:pstyle">trad-T_b</xsl:attribute>
				</xsl:when>
				<xsl:when test="@aid:pstyle='T_3'">
					<xsl:attribute name="aid:pstyle">trad-T_c</xsl:attribute>
				</xsl:when>
				<xsl:when test="@aid:pstyle='T_4'">
					<xsl:attribute name="aid:pstyle">trad-T_d</xsl:attribute>
				</xsl:when>
				<xsl:when test="@aid:pstyle='T_5'">
					<xsl:attribute name="aid:pstyle">trad-T_e</xsl:attribute>
				</xsl:when>
				<xsl:otherwise>
					<xsl:apply-templates select="./@*"/>
				</xsl:otherwise>
