...
<xs:stylesheet xmlns:xs="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xsl xs"
    xpath-default-namespace="http://www.w3.org/1999/XSL/fakeTransform" version="2.0">
    <!-- generate default templates for all elements found -->
